...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/" class="nav-link">ACCUIEL</a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admindashboard" class="brand-link text-center">
      ...
      <span class="brand-text font-weight-light ">PANNEAU ADMIN</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/admindashboard" class="d-block">{{ Auth::user()->name }}</a>
        </div>
      </div>
        ...
        <li class="nav-header"><hr></li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/editadminpassword" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
