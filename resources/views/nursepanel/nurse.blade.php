...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/nursedashboard" class="brand-link text-center">
     
      <span class="brand-text font-weight-light text-center">PANNEAU INFIRMIERE</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/nursedashboard" class="d-block">{{ Auth::user()->name }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <a href="/nursedashboard" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            <a href="/etatpatient" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>
                Consulter etat patient
          ...
          <li class="nav-item">
            <a href="/ncalendar" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="editnursepassword" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
