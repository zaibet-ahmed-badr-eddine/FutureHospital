       ...
       <div class="row">
         <div class="col-sm-4">
           ...
           <div class="small-box bg-info">
             ...
             <a href="/consulte-user/3" class="small-box-footer">Plus D'infos <i class="fas fa-arrow-circle-right"></i></a>
           </div>
         </div>
         <!-- ./col -->
         <div class="col-sm-4">
         ...
         <div class="col-sm-4">
           ...
           <div class="small-box bg-warning">
             ...
             <a href="/consulte-patient" class="small-box-footer">Plus D'infos <i class="fas fa-arrow-circle-right"></i></a>
           </div>
         </div>
